                        ...
                        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <form method="POST" action="{{ route("promotion.update", $promotion) }}">
                                        @csrf
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-8 col-lg-6 col-sm-8">
                                                <input type="text" class="form-control champ" name="designation" id="hDesignation" value="{{ $promotion->designation }}" placeholder="Designation">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-8 col-lg-6 col-sm-8">
                                                <input type="text" class="form-control champ" name="annee" id="hAnnee" value="{{ $promotion->annee }}" placeholder="Annee">
                                            </div>
                                        </div>
